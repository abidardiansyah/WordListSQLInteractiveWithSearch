...
public class WordListOpenHelper extends SQLiteOpenHelper {
     ...
     */
    public com.example.wordlistsqlineractive.WordItem query(int position) {
        String query = "SELECT  * FROM " + WORD_LIST_TABLE +
                " ORDER BY " + KEY_WORD + " ASC " +
                "LIMIT " + position + ",1";

        Cursor cursor = null;
        com.example.wordlistsqlineractive.WordItem entry = new com.example.wordlistsqlineractive.WordItem();
