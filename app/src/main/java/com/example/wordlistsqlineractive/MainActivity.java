...
public class MainActivity extends AppCompatActivity {
    ...
    private com.example.wordlistsqlineractive.WordListAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new com.example.wordlistsqlineractive.WordListAdapter(this, /* mDB.getAllEntries(),*/ mDB);
        ...
        if (requestCode == WORD_EDIT) {
            if (resultCode == RESULT_OK) {
                ...
                if (!TextUtils.isEmpty(word)) {
                    int id = data.getIntExtra(com.example.wordlistsqlineractive.WordListAdapter.EXTRA_ID, -99);
